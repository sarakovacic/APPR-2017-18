...
```{r g0, echo=FALSE, message=FALSE, fig.align='center'}
print(g0)
```
...
```{r g00, echo=FALSE, message=FALSE, fig.align='center'}
print(g00)
```
Podrobna grafa spodaj, prikazujeta spreminjanje površine gozda in letni prirastek samo za Slovenijo.
```{r g3, echo=FALSE, message=FALSE, fig.align='center'}
print(g3)
```
```{r g33, echo=FALSE, message=FALSE, fig.align='center'}
print(g33)
```
...
```{r g2, echo=FALSE, message=FALSE, fig.align='center'}
print(g2)
```
...
```{r g11, echo=FALSE, message=FALSE, fig.align='center'}
print(g11)
```
